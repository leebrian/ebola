/*
to be run on Mar13 using the Mar12 extract
previously run on Mar11 using the Mar10 extract
*/
...
title2		 "List generated based on Mar 12, 2015 EpiInfo dataset";
title3		 "Includes comparisons with Mar 10, 2015 EpiInfo dataset";
...
ods rtf file="C:\sas\output\HCWworkers_12mar.rtf" STYLE=journal nobodytitle;
