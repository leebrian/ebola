/*
to be run on Mar05 using the Mar04 extract
previously run on Mar03 using the Mar02 extract
*/
...
title2		 "List generated based on Mar 04, 2015 EpiInfo dataset";
title3		 "Includes comparisons with Mar 02, 2015 EpiInfo dataset";
...
ods rtf file="C:\sas\output\HCWworkers_04mar.rtf" STYLE=journal nobodytitle;
