/*
to be run on Mar14 using the Mar13 extract
previously run on Mar13 using the Mar12 extract
*/
...
title2		 "List generated based on Mar 13, 2015 EpiInfo dataset";
title3		 "Includes comparisons with Mar 12, 2015 EpiInfo dataset";
...
ods rtf file="C:\sas\output\HCWworkers_14mar.rtf" STYLE=journal nobodytitle;
