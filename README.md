# ebola
Data Quality and Analysis scripts for ebola response - working draft

## Purpose
Collecting together multiple analysis and cleaning scripts written in multiple languages for the West African Ebola response. 
In many cases scripts are specific to a particular workstation, so please adjust your paths as necessary.
The data dictionary is largely based on extracts from the Epi Info VHF database (documentation at https://epiinfovhf.codeplex.com/).
